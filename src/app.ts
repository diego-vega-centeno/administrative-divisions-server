...
import oauthOSMRoute from './routes/oauthOSM.js'
import apiRoute from './routes/apiRoute.js'
import countryRoute from './routes/countryRoute.js'
import layerRoute from './routes/layers.js'
import searchRoute from './routes/searchRoute.js'
import { rateLimit } from 'express-rate-limit'
import cookieParser from 'cookie-parser'
import cors from 'cors'
import { databaseErrorHandler, oauthErrorHandler, generalErrorHandler } from './routes/error-handlers.js'
